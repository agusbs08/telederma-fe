...
<link href="{{asset('css/main.cba69814a806ecc7945a.css')}}" rel="stylesheet"></head>
<body>
...
<div class="app-drawer-overlay d-none animated fadeIn"></div><script type="text/javascript" src="{{asset('js/main.cba69814a806ecc7945a.js')}}"></script></body>
