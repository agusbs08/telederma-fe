      ...
      <div class="dropdown-menu-header-inner bg-focus">
        ...
        <div class="menu-header-content btn-pane-right">
          <div class="avatar-icon-wrapper mr-2 avatar-icon-xl">
            <div class="avatar-icon rounded"><img src="{{ $clinic_detail['profilePicture'] }}" alt="Avatar 5"></div>
          </div>
          <div>
            <h5 class="menu-header-title">{{ $clinic_detail['name'] }}</h5>
            <h6 class="menu-header-subtitle">{{ $clinic_detail['identityNumber'] }}</h6>
            <h6 class="menu-header-subtitle">{{ $clinic_detail['phone'] . ' | ' . $clinic_detail['email'] }}</h6>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="no-gutters row">
      <div class="col-sm-6 col-md-4 col-xl-4">
        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
          ...
          <div class="widget-chart-content">
            ...
            <div class="widget-numbers">{{ $clinic_detail['numberOfSAF'] }}</div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-md-4 col-xl-4">
        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
          ...
          <div class="widget-chart-content">
            ...
            <div class="widget-numbers"><span>{{ $clinic_detail['numberOfLI'] }}</span></div>
          </div>
        </div>
        <div class="divider m-0 d-md-none d-sm-block"></div>
      </div>
      <div class="col-sm-12 col-md-4 col-xl-4">
        <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
          ...
          <div class="widget-chart-content">
            <div class="widget-subheading">Pasien Terdaftar</div>
            <div class="widget-numbers text-success">
              <span>
                {{ count($clinic_detail['patients']) }}
              </span>
            </div>
          </div>
        </div>
            ...
            <div class="vertical-timeline-item dot-success vertical-timeline-element">
              <div>
                ...
                <div class="vertical-timeline-element-content bounce-in">
                  <h4 class="timeline-title">{{ $clinic_detail['name'] }} melakukan live interactive -
